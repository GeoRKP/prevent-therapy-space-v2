  ...
  return (
    <div className={cn("mb-16", centered ? "text-center" : "max-w-2xl")}>
      {label && (
        <RevealText>
          <div className="inline-flex items-center gap-3 mb-5">
            ...
            {centered && <div className="w-8 h-px bg-brand/70" />}
          </div>
        </RevealText>
      )}
      ...
      <RevealText delay={0.1}>
        <h2
          id={id}
          className="text-3xl md:text-4xl lg:text-5xl font-bold leading-tight tracking-tight text-ink mb-5"
        >
          {title}
        </h2>
      </RevealText>
      ...
      {subtitle && (
        <RevealText delay={0.2}>
          <p
            className={cn(
              "text-base lg:text-lg text-ink-55 max-w-2xl leading-relaxed",
              centered ? "mx-auto" : ""
            )}
          >
            {subtitle}
