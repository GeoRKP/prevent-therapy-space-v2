          ...
          {steps.map((step, i) => {
            ...
            return (
              <motion.div
                ...
                className="group relative bg-canvas hover:bg-canvas-2 border border-ink/[0.06] hover:border-brand/30 rounded-2xl p-7 lg:p-8 transition-all"
              >
                ...
                <h3 className="text-lg font-bold text-ink mb-2.5 group-hover:text-brand transition-colors">
