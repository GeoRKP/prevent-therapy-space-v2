        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {services.map((service, index) => {
            ...
            return (
              ...
              >
                <div className="group relative h-full bg-surface-1 hover:bg-surface-2 border border-white/[0.06] hover:border-primary/30 rounded-2xl p-7 lg:p-8 transition-all duration-500">
