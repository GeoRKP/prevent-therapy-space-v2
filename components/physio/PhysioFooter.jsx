...
export function PhysioFooter() {
  ...
  return (
    <footer className="relative bg-surface-deep text-paper overflow-hidden border-t border-white/[0.06]">
      <div className="relative z-10 container">
        <div className="py-12 lg:py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
          <div className="lg:col-span-1">
            <Link href="/" className="inline-flex items-center gap-3 mb-6">
              <Image
                ...
                className="h-10 w-10"
              />
              <span className="text-base font-bold tracking-wider text-paper">
                PREVENT
              </span>
            </Link>

            <p className="text-paper/70 text-sm leading-relaxed mb-7 max-w-xs">
            ...
            <div className="space-y-2.5">
              <a
                ...
                className="group flex items-center gap-3 text-paper/70 hover:text-paper text-sm transition-colors"
              >
          ...
          <div>
            <h4 className="text-xs font-semibold uppercase tracking-[0.18em] text-paper/70 mb-6">
            ...
            <ul className="space-y-2.5">
              {navLinks.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="group inline-flex items-center gap-2 text-paper/72 hover:text-primary-soft text-sm transition-colors"
                  >
            ...
            <ul className="space-y-2.5">
              {services.map((service, index) => (
                <li key={index}>
                  <Link
                    href="/services"
                    className="text-paper/72 hover:text-primary-soft text-sm transition-colors"
                  >
                    {service}
                  </Link>
                </li>
          ...
          <div>
            ...
            <a
              ...
              className="group flex items-start gap-3 text-paper/70 hover:text-paper text-sm transition-colors mb-6"
            >
            ...
            <div className="rounded-2xl border border-white/[0.06] bg-white/[0.02] p-4 text-sm space-y-2">
              <div className="flex items-center gap-2 text-paper/88 font-medium mb-1">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-paper/88 font-medium">
        ...
        <div className="py-6 border-t border-white/[0.06] flex flex-col md:flex-row justify-between items-center gap-3">
          <p className="text-paper/52 text-xs">
            {t("footer:copyright", { year: new Date().getFullYear() })}
          </p>
          <div className="flex gap-5 text-paper/52 text-xs">
